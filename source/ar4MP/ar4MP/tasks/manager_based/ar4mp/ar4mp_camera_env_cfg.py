...
from .ar4mp_env_cfg import AR4MPEnvCfg, AR4MPSceneCfg
...
@configclass
class AR4MPRGBCameraSceneCfg(AR4MPSceneCfg):
...
@configclass
class AR4MPDepthCameraSceneCfg(AR4MPSceneCfg):
...
@configclass
class AR4MPRGBCameraEnvCfg(AR4MPEnvCfg):
    """Configuration for the AR4MP environment with RGB camera."""

    scene: AR4MPRGBCameraSceneCfg = AR4MPRGBCameraSceneCfg(num_envs=128, env_spacing=20)
...
@configclass
class AR4MPDepthCameraEnvCfg(AR4MPEnvCfg):
    """Configuration for the AR4MP environment with depth camera."""

    scene: AR4MPDepthCameraSceneCfg = AR4MPDepthCameraSceneCfg(num_envs=128, env_spacing=20)
...
@configclass
class AR4MPResNet18CameraEnvCfg(AR4MPRGBCameraEnvCfg):
    """Configuration for the AR4MP environment with ResNet18 features as observations."""

    observations: ResNet18ObservationCfg = ResNet18ObservationCfg()


@configclass
class AR4MPTheiaTinyCameraEnvCfg(AR4MPRGBCameraEnvCfg):
    """Configuration for the AR4MP environment with Theia-Tiny features as observations."""
