...
@configclass
class AR4MPSceneCfg(InteractiveSceneCfg):
...
class CommandsCfg:
    ...
    ee_pose = mdp.WaypointCommandCfg(
        asset_name="robot",
        body_name=MISSING,
...
@configclass
class AR4MPEnvCfg(ManagerBasedRLEnvCfg):
    # Scene settings
    scene: AR4MPSceneCfg = AR4MPSceneCfg(num_envs=4096, env_spacing=4.0)
    # Basic settings
